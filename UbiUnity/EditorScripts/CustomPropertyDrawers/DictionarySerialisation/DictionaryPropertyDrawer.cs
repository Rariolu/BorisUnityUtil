...
{
    /// <summary>
    /// A class used to draw a dictionary in the editor
    /// (so it can be edited). Found here
    /// https://github.com/lordofduct/spacepuppy-unity-framework/blob/master/SpacepuppyBaseEditor/Collections/DictionaryPropertyDrawer.cs#L12
    /// </summary>
